...
def add_employee(name='Null',age='Null',phone='Null',job='Null'):
    ...
    with open('employee_data', 'r+', encoding='utf-8') as f1:
        ...
        f1.write('\n{id},{name},{age},{phone},{job}'.format(id=id, name=name, age=age, phone=phone,job=job))
...
user_input_search = input('select * where ')
del_employee(user_input_search)
# ret_cel = choose_search_part('select name, age where age like 2')
# ret_cel = choose_search_part('select * where phone like 432')
# print(ret_cel)
# add_employee('xiaochen', '23','1800000000','worker')
