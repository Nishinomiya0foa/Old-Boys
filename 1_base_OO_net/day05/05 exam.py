...
# lis[1][2]['k1'][0] = lis[1][2]['k1'][0].replace(lis[1][2]['k1'][0], 'TT')
# lis = ['k', ['qwe', 20, {'k1':['TT', 3, '1']}, 89], 'ab']
# print(lis)
...
#     if i % 2 != 1 and user_input[i].isdigit():
#         n+=1
# print(n)
...
#     lis.append(key)
# result.clear()
# result['bigger_num'] = lis
# set2 = set(li) - set(lis)
# lis2 = list(set2)
# result['small_num'] = lis2
# print(result)
...
# for row in li:
#     if row > 66:
#         if 'num_bigger' not in result:
#             result['num_bigger'] = []
#         result['num_bigger'].append(row)
#     else:
#         if 'num_smaller' not in result:
#             result['num_smaller'] = []
#         result['num_smaller'].append(row)
# print(result)
